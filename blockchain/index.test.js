...
describe('Blockchain', () => {
    ...
    describe('isValidChain()', ()=>{
        ...
        describe('when the chain starts with the genesis block and has multiple blocks', ()=>{
            ...
            beforeEach(()=>{
                ...
                blockchain.addBlock({data:'Beast'});
            });
    ...
    describe('replaceChain()', ()=>{
        ...
        describe('when the new chain is longer', ()=>{
            ...
            beforeEach(()=>{
                ...
                newChain.addBlock({data:'Beast'});
            });

            describe('and the chain is invalid', ()=>{
                beforeEach(()=>{
                    newChain.chain[2].hash = 'something';
                    blockchain.replaceChain(newChain.chain);
                });
                it('does not replace the chain', ()=>{
                    expect(blockchain.chain).toEqual(originalChain);
        ...
        describe('and the `validateTransactions` flag is true', ()=>{
            it('calls validTransactionData()', ()=>{
                ...
                validTransactionDataMock = jest.fn();
                blockchain.validTransactionData = validTransactionDataMock;

                newChain.addBlock({data: 'foobar'});
    ...
    describe('validTransactionData()', ()=>{
        ...
        beforeEach(()=>{
            wallet = new Wallet();
            transaction = wallet.createTransaction({recipient:'foooo', amount:20});
